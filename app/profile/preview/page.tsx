        ...
        <div className="relative w-full md:w-1/2 min-h-[40vh] md:min-h-screen">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/70 to-transparent px-8 pt-24 pb-8">
            ...
            <div className="mt-2 flex items-center gap-3">
              <Link href="/reviews">
                <span className="inline-flex items-center gap-1 rounded-lg bg-white/90 backdrop-blur px-2.5 py-1 text-sm hover:bg-white transition-colors">
                  <Star className="h-3.5 w-3.5 fill-amber-400 text-amber-400" />
                  <span className="font-medium text-slate-700">{averageRating !== null ? `${averageRating} Rating` : "New"}</span>
                </span>
              </Link>
              <Link href="/reviews">
                <span className="text-sm text-white/80 underline-offset-4 hover:underline">{totalCount} Review{totalCount === 1 ? "" : "s"}</span>
              </Link>
            </div>
          </div>
        </div>

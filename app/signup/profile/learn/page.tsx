...
export default function LearnSkills() {
  ...
  // Background scattered icons — same palette as all onboarding screens
  const bgIcons = [
  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col py-10 px-6 overflow-hidden select-none">
      ...
      {/* ── Body ── */}
      <div className="relative z-10 w-full max-w-[430px] mx-auto flex-1 flex flex-col gap-6">
        ...
        {/* Toggleable Skill Grid — squircle tags */}
